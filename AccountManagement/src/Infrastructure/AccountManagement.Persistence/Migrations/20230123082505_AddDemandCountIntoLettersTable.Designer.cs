...
namespace AccountManagement.Persistence.Migrations
{
    ...
    [Migration("20230123082505_AddDemandCountIntoLettersTable")]
    partial class AddDemandCountIntoLettersTable
    {
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(1658));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(1717));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.BlockAccountTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(5065));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(5121));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(2401));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(2489));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.DemandPacket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(2816));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(2881));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Letter", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(615));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(793));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(4105));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(4193));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.WithdrawAccountTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(5717));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 23, 0, 25, 5, 734, DateTimeKind.Local).AddTicks(5802));
